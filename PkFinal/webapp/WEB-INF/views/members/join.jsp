	        ...
	        <tr>
	        	...
	        	<div>
	        		<table>
	        			<tr>
	        				<td>아이디</td>
	        				<td><input type="text" name="m_uid" placeholder="아이디"  id="idDupCheckBtn" autocomplete = off required />
	        			...
	        			<tr>
	        				<td>주소</td>
	        				<td>
	        					<input type="text" name="m_zipcode" placeholder="우편번호" id="zonecode" onclick="fn_setAddr();" readonly required/>
								<input type="text" name="m_city" placeholder="시도" id="sido" onclick="fn_setAddr();" readonly required/>
								<input type="text" name="m_gugun" placeholder="구군" id="sigungu" onclick="fn_setAddr();" readonly required/>
								<input type="text" name="m_addr" placeholder="상세주소" id="addr"   required/>
